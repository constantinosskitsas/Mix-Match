...
#algo=["FT2_DV","FT4_DV","DVS"]
#algo=["_DVGM","FT1_DVGM","FT2_DVGM","FT3_DVGM","FT4_DVGM","_LFSK","_LFTJK"]
algo=["DV","FT1_DV","FT2_DV","FT3_DV","FT4_DV","FTR_DV"]
#algo=["FT2_DV","FT4_DV","VEQ","RM","DVS"]
algo=["FT2_DV","FT4_DV","DVS"]
#algo=["FT2_DV","FT4_DV","LFTJ","RM","VEQ","DVS"]
algo=["VEQ","FT2_DV","FT4_DV","DVS"]
#algo=["DV","FT1_DV","FT2_DV","FT3_DV","FT4_DV","FTR_DV"]
algo=["LFTJ","RM"]
...
#for i in range(len(pathsize)):
    for j in range(len(timts)):
        ...
        with open(f'{FMPath}{algo[i]}_-1_dblp_G_64_{timts[j]}{endf}', 'r') as file:
            for line in file:
                values = line.split()
                if(counter<1000):
...
#print("Time LFTJ RM VEQ DIV2 DIV4 DVS DLSP")
print(algo)
for j in range(len(timts)): 
    print(timts[j],end=' ')   
